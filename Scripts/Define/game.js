var game =
    {
        ...
        mineObjects: [
            ...
            new MineObject("cursedBone", 45e9, 33.5e6, 1.05e12, ["#000000", "#660066", "#6699ff"], 3),
            new MineObject("windEssence", 68e9, 48e6, 1.7e12, ["#000000", "#aaffff", "#66ffff"], 4),
            new MineObject("unobtanium", 100e9, 69e6, 3e12, ["#000000"], 10),
            new MineObject("sollite", 130e9, 95e6, 4.8e12, ["#ffff00", "#ffff00", "#ff6600"], 5),
            new MineObject("waterEssence", 175e9, 138e6, 7.2e12, ["#000000", "#0000ff", "#0033ff"], 4),
            ...
            new MineObject("shadowEssence", 435e9, 440e6, 30e12, ["#000000", "#4400ac", "#000000"], 4),
            ...
            new MineObject("lightEssence", 1.35e12, 2e9, 170e12, ["#000000", "#ffcc00", "#ffffff"], 4),
            new MineObject("soulstone", 1.8e12, 3.1e9, 270e12, ["#00ffff", "#003366"]),
            new MineObject("arcanium", 2.4e12, 4.8e9, 420e12, ["#ffff99", "#ccffff"]),
            new MineObject("hellstone1", 3.2e12, 7e9, 680e12, ["#00ff00", "#ff0000"], 9),
            new MineObject("hellstone2", 7e12, 15e9, 3.5e15, ["#00ff00", "#cd0000"], 9),
            new MineObject("hellstone3", 16e12, 36e9, 26e15, ["#00ff00", "#9c0000"], 9),
            new MineObject("hellstone4", 42e12, 89e9, 200e15, ["#00ff00", "#580000"], 9),
            new MineObject("hellstone666", 666e12, 3.66e12, 16.66e18, ["#00ff00", "#300000"], 12),
            new MineObject("infinitum", 3e15, 4e12, 150e18, ["#ffffff", "#ffffff", "#000000"], 11),
            new MineObject("omegaEssence", 10e15, 13e12, 1e21, ["#000000", "#2f0036", "#8b00ff"], 4),
            ...
            new MineObject("zettaWattCrystal", 300e15, 600e12, 240e21, ["#ff0090", "#00ffd7"], 6),
            new MineObject("theGem", 3.333e18, 9.99e15, 5.555e24, ["#00e7ff", "#005cff", "#0099ff"], 14),
            new MineObject("boneOfInfinity", 12.345e18, 27.89e15, 43.21e24, ["#ffffff", "#000000", "#000000"], 3),
            new MineObject("paperOfGods", 50e18, 111e15, 200e24, ["#6a6600", "#ffffff", "#ffffff", "#dada00"], 13),
            new MineObject("heavenstone", 250e18, 600e15, 2.222e27, ["#00cfff", "#fffc6a"], 9),
            new MineObject("holoStone", 1.111e21, 2.5e18, 19.876e27, ["#00b10d"], 10),
            new MineObject("antiMud", 4e21, 10e18, 123.456e27, ["#663300", "#1b0d00"]),
            new MineObject("quantumOrb", 10.101e21, 22.020e18, 505.55e27, ["#00ff00", "#000000", "#163d16"], 5),
            new MineObject("sourceOfPower", 60e21, 140e18, 6e30, ["#c3c000", "#fffa64"], 6),
            new MineObject("fractalium", 500e21, 1.333e21, 150e30, ["#000000", "#0088ff", "#101010"], 15),
            new MineObject("postInfinityEssence", 4.444e24, 11.111e21, 2.222e33, ["#000000", "#000000", "#ffffff"], 4),
            new MineObject("unsolvium", 44.44e24, 133.33e21, 99.999e33, ["#000000", "#7dff00", "#003401"], 7),
            new MineObject("thePortal", 1e27, 10e24, 10e36, ["#ff0389", "#ff0039"], 16),            
        ],        
        specialMineObjects:
            [
